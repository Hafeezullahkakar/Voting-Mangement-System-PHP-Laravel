            ...
            <div class="row g-0">
                ...
                <div class="card-body p-md-5 mx-md-2">
                  <div class="text-center">
                    ...
                    <h5 class="mt-1 mb-2 pb-1">
                      Be our Representative and make us proud
                    </h5>
                  </div>

                  <form action="/candidatestore" method="POST" enctype='multipart/form-data'>
                    @csrf

                    <div class="form-outlined mb-4">
                      <!-- <label class="form-label" for="form2Example11">Username</label> -->
                      <input type="text" name="name" id="form2Example11" class="form-control" placeholder="Full Name (same as in documents)" />
                      <span style="color:red">@error('name'){{$message}} @enderror</span>
                    </div>
                    <div class="form-outlined mb-4">
                      <!-- <label class="form-label" for="form2Example11">Username</label> -->
                      <input type="text" name="cnic" id="form2Example11" class="form-control" placeholder="CNIC number (without spaces)" />
                    ...
                    <div class="form-outlined mb-4">
                      <!-- <label class="form-label" for="form2Example11">Username</label> -->
                      <input type="number" name="phone" id="form2Example11" class="form-control" placeholder="mobile number" />
                    ...
                    <div class="form-outlined mb-4">
                      <input type="file" name="symbol" id="form2Example22" class="form-control" />
                      <span style="color:red">@error('symbol'){{$message}} @enderror</span>
                    ...
                    <div class="text-center pt-1 mb-2 pb-1">
                      ...
                      <a class="text-muted" href="{{url('/')}}">Go to Homepage </a>
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <button type="button" class="btn btn-outline-danger">
                        <a href="{{url('CandidateLogin')}}" class="text-danger">
                          Login now!</a>
                      </button>
                    </div>
                  </form>
              ...
              <div class="col-lg-6 d-flex align-items-start gradient-custom-2">
                <div class="text-black px-3 py-4 p-md-5 mx-md-4">
                  <img src="{{url('frontend/assets/cand.jpeg')}}" class="imageVot" alt="logo" width="400px" height="550px" />
                  <h4 class="mt-4">Be our Representative!</h4>
                  <p class="small mb-0">
                    We feel proud to have you represent us in the
                    lagislations.
                  </p>
                </div>
              </div>
