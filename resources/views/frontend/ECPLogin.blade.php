            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form method="GET" action="/ECPDashboard">
                    @csrf
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <button type="button" class="btn btn-outline-danger">
                        <a href="{{'ECPRegister'}}" class="text-danger">
                          Get Registerd now!
                        </a>
                      </button>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-start gradient-custom-2">
                <div class="text-black px-3 py-4 p-md-5 mx-md-4">
                  <img src="{{('frontend/assets/ecp.png')}}" class="imageVot" alt="logo" width="350px" height="450px" />
                  <h4 class="mt-5">Election Commission of Pakistan</h4>
                  <p class="small mb-0">
                    Election commission of Pakistan is up to shift to online
                    voting. Now you can vote from your mobile.
                  </p>
                </div>
              </div>
            </div>
