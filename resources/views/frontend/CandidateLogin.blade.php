            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <form method="GET" action="/CandidateDashboard">
                    @csrf
                    <p></p>
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <button type="button" class="btn btn-outline-danger">
                        <a href="{{url('CandidateReg')}}" class="text-danger">
                          Get Registerd now!
                        </a>
                      </button>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-start gradient-custom-2">
                <div class="text-black px-3 py-4 p-md-5 mx-md-4">
                  <img src="{{url('frontend/assets/cand.jpeg')}}" class="imageVot" alt="logo" width="400px" height="450px" />
                  <h4 class="mt-4">
                    Be our Representative!
                  </h4>
                  <p class="small mb-0">
                    We feel proud to have you represent us in the lagislations.
                  </p>
                </div>
