            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  <div class="text-center">
                    ...
                    <h4 class="mt-4 mb-5 pb-1">Vote to make a difference!</h4>
                  </div>

                  <form method="GET" action="/VoterDashboard">
                    @csrf

                    <div class="form-outlined mb-4">
                      <!-- <label class="form-label" for="form2Example11">Username</label> -->
                      <input name="cnic" type="text" id="form2Example11" class="form-control" placeholder="CNIC number (without spaces)" name='email' />
                    ...
                    <div class="form-outlined mb-4">
                      ...
                      <input name="password" type="password" placeholder="password" id="form2Example22" class="form-control" name="password" />
                    ...
                    <div class="text-center pt-1 mb-5 pb-1">
                      <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">
                        <!-- <a href="{{'/VoterDashboard'}}" class="text-white"> -->
                        Log in
                        <!-- </a> -->
                      </button>
                      <a class="text-muted" href="/">go to homepage</a>
                    </div>

                    <div class="d-flex align-items-center justify-content-center pb-4">
                      <p class="mb-0 me-2">Not registed yet?</p>
                      <button type="button" class="btn btn-outline-danger">
                        <a href="{{'/VoterReg'}}" class="text-danger">
                          Get Registerd now!
                        </a>
                      </button>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-start gradient-custom-2">
                <div class="text-black px-3 py-4 p-md-5 mx-md-4">
                  ...
                  <h4 class="mt-4">To Vote is your Right!</h4>
                  <p class="small mb-0">
                    Every single vote counts. So do get yourself registered
                    and vote to make the difference.
                  </p>
                </div>
              </div>
            </div>
